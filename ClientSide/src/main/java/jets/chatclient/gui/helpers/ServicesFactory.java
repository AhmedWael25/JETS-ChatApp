...
public class ServicesFactory {
    ...
    public  UserProfileServiceInt getUpdateProfileService() throws  RemoteException, NotBoundException{
        return (UserProfileServiceInt) reg.lookup("UserProfileService");
    }
